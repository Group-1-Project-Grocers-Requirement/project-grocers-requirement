...
const routes: Routes = [
  ...
  { path: 'employee-index', component: EmployeeIndexComponent,children:[
    { path: '', component: UpdateOrderStatusComponent },
    { path: 'edit-employee-profile', component: EditProfileComponent },
    { path: 'send-request', component: SendRequestComponent },
    { path: 'unlock-users', component: UnlockUsersComponent },
